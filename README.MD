# SI-ML-Generator: Single-Instrument Music-Loops Generator. What is it?
...
- **AudioLDM2-Music**: very unexpected results, can be interesting for experimental generative sounds, expecially on long sounds. Not very trustable when it comes to the Key and BPM constraints.
...
- **CUDA drivers** and a **CUDA-compatible GPU** are required.  
  ...
  It may also work on **T4 GPUs**, but memory is often insufficient to complete inference.
